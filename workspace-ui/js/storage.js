...
// ── Key constants ──
export const KEYS = {
  THEME: 'broodlink-theme',
  TOGGLES: 'broodlink-toggles',
  ...
  MODELS_EXPANDED: 'broodlink-model-expanded',
  MODEL_ENDPOINTS: 'broodlink-model-endpoints',
  MODEL_SELECTED: 'broodlink-selected-model',
  SORT_ORDER: 'broodlink-sessions-sort',
  CHAT_SEARCH_SCOPE: 'broodlink-search-scope',
  INCOGNITO: 'broodlink-incognito',
  RAG_ACTIVE: 'broodlink-rag-active',
  MCP_ACTIVE: 'broodlink-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'broodlink-density'
};
