...
const COLLAPSE_KEY = 'broodlink-models-collapsed';
const FAVORITES_KEY = 'broodlink-model-favorites';
const USAGE_KEY = 'broodlink-model-usage';
const SORT_KEY = 'broodlink-model-sort';
