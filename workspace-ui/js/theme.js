...
const LS_KEY = 'broodlink-theme';
const CUSTOM_THEMES_KEY = 'broodlink-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Broodlink Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'broodlink_' + (obj.name || 'theme') + '.json';
      a.click();
