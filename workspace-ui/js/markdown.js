...
function initMermaid() {
  if (!window.mermaid || window.__broodlinkMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__broodlinkMermaidReady = true;
}
window.broodlinkInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'broodlink-thinking-expanded';
